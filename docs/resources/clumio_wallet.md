...
page_title: "clumio_wallet Resource - terraform-provider-clumio-internal"
subcategory: ""
description: |-
...
- `clumio_control_plane_account_id` (String) Clumio Control Plane Account ID.
- `id` (String) Wallet Id.
- `installed_regions` (Set of String) The regions where the wallet is installed.
...
- `supported_regions` (Set of String) The supported regions for the wallet.
